...
specials_table = {
    ...
    "Fly": {"mp": 2, "ap": 1, "cost": "EP or FP 3", "desc": "Can fly or levitate."},
    "Haste": {"mp": 8, "ap": 3, "cost": "EP 12", "desc": "Grants target 1 AP for SR 1 (rounds). Adjust MP: 4"},
    ...
    "Melee AoE": {"mp": 8, "ap": 2, "cost": "FP 12", "desc": "Wide melee strike. Base WR 8. Adjust MP: 4"},
    "Mind Shatter": {"mp": 8, "ap": 2, "cost": "EP 12", "desc": "Causes psychic disruption: stagger, stun, or disorientation. SR 0 (rounds). Adjust MP: 4"},
    "Mutate": {"mp": 2, "ap": 1, "cost": "EP 3 or PA", "desc": "Applies a modifier to creatures or items. Base SR 0 or ± 1. Adjust MP: 2"},
    ...
    "Polymorph / Shape Shift": {"mp": 8, "ap": 2, "cost": "12", "desc": "Polymorph as per the spell. Adjust MP: 3"},
    "Reactive Defense": {"mp": 6, "ap": 1, "cost": "FP 9 or PA", "desc": "When struck, automatically triggers a defensive reaction. Base SR of 6. Adjust MP: 2"},
    "Reduced Damage": {"mp": 2, "ap": 1, "cost": "EP or FP 3, or PA", "desc": "Increases all DV by 2 for SR 0 (rounds) or reduce incoming type damage by 1 point. Adjust MP: 2"},
...
with st.expander("MP Cost Breakdown"):
    # Size MP Cost
    size_mp_table = {
        "Diminutive": -4, "Tiny": -2, "Small": -1, "Medium": 0, "Large": 1,
        "Huge": 2, "Gigantic": 4, "Colossal": 8
    }
