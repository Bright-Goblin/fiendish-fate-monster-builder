...
specials_table = {
    # Core Effects
    "Breath Weapon": {"mp": 8, "ap": 2, "cost": "FP 16", "desc": "Exhales energy in a cone. Base WR 8 damage. +4 MP per increase."},
    "Burrow": {"mp": 3, "ap": 1, "cost": "FP 0", "desc": "Tunnel through terrain as move action."},
    "Charm": {"mp": 6, "ap": 3, "cost": "EP 12", "desc": "Charm as per the spell. +3 MP per increase."},
    "Corpse Explosion": {"mp": 7, "ap": 2, "cost": "EP 14", "desc": "Detonates a corpse for AoE damage. Base SR 6 damage. +4 MP per increase."},
    "Corruption": {"mp": 4, "ap": 2, "cost": "EP 8", "desc": "Persistent damage from a poison or other effect; SR 1 incorporeal damage for SR 1 (rounds). +2 MP per curse"},
    "Curse": {"mp": 6, "ap": 2, "cost": "EP 12", "desc": "Curse as per the spell; must be cured to be removed. +6 MP per curse"},
    "Death": {"mp": 12, "ap": 2, "cost": "EP 24", "desc": "Instant death as per Word of Death spell."},
    "Disease": {"mp": 5, "ap": 2, "cost": "FP 10", "desc": "Inflicts a disease; must be cured to be removed. +2 MP per increase or additional effect."},
    "Entangle": {"mp": 6, "ap": 2, "cost": "FP 12", "desc": "Restrains or slows enemies with webbing, tendrils, or other physical means. +3 MP per increase."},
    "Environment Mastery": {"mp": 5, "ap": 0, "cost": "FP 0", "desc": "Ignores penalties and gains advantages in a specific terrain type. +3 MP per penalty ignored or advantage granted."},
    "Essence Drain": {"mp": 4, "ap": 2, "cost": "EP 8", "desc": "Drains attributes, EP, FP, or levels; SR 1 incorporeal damage. +2 MP per increase."},
    "Essence Stealing": {"mp": 7, "ap": 2, "cost": "EP 14", "desc": "Absorbs EP, FP, or HP from targets; SR 6 damage (corporeal) or 1 damage (incorporeal) and healing equal to damage done. +4 MP per increase."},
    "Exploding Corpse": {"mp": 10, "ap": 0, "cost": "—", "desc": "Creatures’ corpse explodes for SR 6 damage upon its death. +3 MP per increase."},
    "Extra Damaging": {"mp": 4, "ap": 0, "cost": "—", "desc": "Deals +1D6 bonus damage. +4 MP per die; maximum 5D6."},
    "Fast Healing": {"mp": 4, "ap": 0, "cost": "—", "desc": "Regenerates 1D6 HP per round. +4 MP per die; maximum 5D6."},
    "Fear": {"mp": 4, "ap": 2, "cost": "EP 8", "desc": "Fear as per the spell. 2 MP per increase."},
    "Fly": {"mp": 4, "ap": 1, "cost": "FP 0", "desc": "Can fly or levitate."},
    "Haste": {"mp": 8, "ap": 2, "cost": "EP 16", "desc": "Grants target 1 AP for SR 1 (rounds). +4 MP per increase."},
    "Immunity": {"mp": 10, "ap": 0, "cost": "—", "desc": "Immunity to a single damage type, technique, lore or effect. +8 MP per additional immunity."},
    "Invisibility": {"mp": 6, "ap": 2, "cost": "FP 12", "desc": "Invisible as per the spell. +3 MP per increase"},
    "Magical Absorption": {"mp": 8, "ap": 2, "cost": "EP 16", "desc": "Absorbs magic, converting it to EP or FP. Base SR 8. +4 MP per increase."},
    "Material Ruin": {"mp": 8, "ap": 2, "cost": "EP 16", "desc": "Degrades or corrodes weapons or armor, by one condition level, on hit. +4 MP per extra condition level lost."},
    "Melee AoE": {"mp": 8, "ap": 2, "cost": "FP 16", "desc": "Wide melee strike. Base WR 8. +4 MP per increase."},
    "Mind Shatter": {"mp": 8, "ap": 2, "cost": "EP 16", "desc": "Causes psychic disruption: stagger, stun, or disorientation. SR 1 (rounds). +3 MP per increase"},
    "Night Vision": {"mp": 2, "ap": 0, "cost": "—", "desc": "Creature can see in darkness as though it were dim light up to 60 feet. +2 MP per addtional 20 feet range."},
    "Paralysis": {"mp": 8, "ap": 2, "cost": "EP 16", "desc": "Paralysis status condition; SR 2 (rounds). +4 MP per increase."},
    "Parasitic Infection": {"mp": 4, "ap": 2, "cost": "EP 10", "desc": "Embeds a parasite causing ongoing drain, delayed transformation, or secondary effects. +2 MP per increase."},
    "Petrify": {"mp": 10, "ap": 2, "cost": "EP 20", "desc": "Petrification status condition; SR 2 (rounds). +5 MP per increase."},
    "Phase": {"mp": 4, "ap": 1, "cost": "EP 8", "desc": "Walks through matter for SR 3 rounds. +3 MP per increase."},
    "Plane Shift": {"mp": 8, "ap": 2, "cost": "EP 16", "desc": "Shifts to another plane of existence. +3 MP per increase."},
    "Polymorph / Shape Shift": {"mp": 8, "ap": 2, "cost": "16", "desc": "Polymorph as per the spell. +3 MP per increase."},
    "Reactive Defense": {"mp": 6, "ap": 1, "cost": "FP 6", "desc": "When struck, automatically triggers a defensive reaction. Base SR of 1. +2 MP per increase."},
    "Reduced Damage": {"mp": 3, "ap": 1, "cost": "FP 6", "desc": "Increases all DV by 2 for SR 1 (rounds). +2 MP per increase."},
    "Regeneration": {"mp": 12, "ap": 0, "cost": "FP 24", "desc": "Regrows lost limbs or body over time."},
    "Resistances": {"mp": 6, "ap": 0, "cost": "—", "desc": "Takes half damage from one damage type. +3 MP per additional resistance."},
    "Shatter Weapon": {"mp": 5, "ap": 1, "cost": "FP 10", "desc": "Destroys a mundane weapon on a successful parry. +5 MP to destroy magical weapons."},
    "Sleep": {"mp": 6, "ap": 2, "cost": "EP 12", "desc": "Sleep as per the spell. +3 MP per increase."},
    "Slime Trail": {"mp": 3, "ap": 0, "cost": "—", "desc": "Leaves difficult or damaging terrain behind."},
    "Slow": {"mp": 8, "ap": 3, "cost": "EP 16", "desc": "Lowers target’s AP by 1 for SR 1 (rounds). +4 MP per increase."},
    "Soul Anchor": {"mp": 12, "ap": 0, "cost": "EP 24", "desc": "Prevents true death or binds the soul. May cause delayed consequences or reforming."},
    "Spell Reflection": {"mp": 8, "ap": 1, "cost": "EP 16", "desc": "Reflects a spell back at caster once per round for SR 1 (rounds). +3 MP per increase."},
    "Summon": {"mp": 6, "ap": 3, "cost": "EP 12", "desc": "Summon SR 1 creatures for SR 1 (rounds). 3 MP per increase."},
    "Swallow Whole": {"mp": 10, "ap": 2, "cost": "FP 20", "desc": "Swallows target two sizes smaller. +3 MP per increase."},
    "Teleport": {"mp": 6, "ap": 3, "cost": "EP 12", "desc": "Teleport to another visible or known location on same plane."},
    "Trample": {"mp": 4, "ap": 1, "cost": "FP 8", "desc": "Charge that knocks down enemies. WR 6 damage. +3 MP per increase."},
    "Volatile Blood": {"mp": 6, "ap": 0, "cost": "—", "desc": "Damage from melee attacks or bleeds cause the creature’s blood to react violently, splashing corrosive ichor, igniting sparks, or releasing noxious fumes. SR 3 damage. +3 MP per increase."}
}
