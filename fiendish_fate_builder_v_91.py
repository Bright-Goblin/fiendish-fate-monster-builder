...
initiative = st.number_input("Initiative (-8 to 20); DEX mod added in stat block", -8, 20, 3)
...
# --- Weapons ---
st.subheader("Weapons (1 to 40); STR mod added in stat block")
weapons = []
wr_values = []
for i in range(1, 4):
...
# --- DV Breakdown ---
st.subheader("Armor - DV (-8 to 35); TOU Grit mod added in stat block")
dv_input = {}
